...
export default function HeroTitle() {
  ...
  useGSAP(
    (_context, contextSafe) => {
      ...
      const run = contextSafe(() => {
        ...
        ref.current.setAttribute("aria-label", "Daily Help That Flows With Care.");
  ...
  return (
    <h1
      ref={ref}
      className="mx-auto max-w-4xl text-6xl leading-[1.02] tracking-tight sm:text-7xl lg:text-8xl"
      style={{ fontFamily: "var(--font-serif)", color: NOCTURNE.text }}
    >
      ...
      <span className="block">
        ...
        <span className="inline-block overflow-hidden align-bottom">
          <span className="inline-block" data-hero-rotate>
            {/* italic on the closing word — the serif's own voice lifting */}
            <em>
              <WordRotate />
            </em>
          </span>
