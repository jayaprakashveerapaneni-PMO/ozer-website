...
export const SITE = {
  name: "Ozer",
  title: "Ozer — Daily Help, Delivered | Verified Home Services in Hyderabad",
  description:
    "Book police-verified house cleaners, home cooks, laundry and child & elder care in Hyderabad in about two minutes. Transparent upfront pricing, secure payment, money-back promise.",
...
export const ROUTES = [
  ...
  { path: "/assistants", priority: 0.6, changeFrequency: "monthly" as const },
